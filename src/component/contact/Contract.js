...
import "./Contract.css";
function Contract({scrollRef}) {
  return (
    <>
      <div ref={scrollRef} className="contract__container">
        <h1>CONTRACT ME</h1>
        <div class="arch_contact_us_duplicate">
          <div class="responsive-container-block big-container">
            <div class="responsive-container-block container">
              <div
                class="responsive-cell-block wk-mobile-12 wk-desk-5 wk-tab-10 wk-ipadp-5"
                id="ih6s"
              >
                <p class="text-blk section-head">Get in touch dolor sit</p>
              ...
              <div
                class="responsive-cell-block wk-ipadp-6 wk-mobile-12 wk-desk-5 wk-tab-9"
                id="i6df"
              >
